...
<form action="{{ route('for.update',$for->id) }}" method="post">
            @csrf
            @method("put")
            ...
            <h2>Provider Overview</h2>
                <div class="form-group row">
                    <div class="cl">
                        ...
                        <input type="text" class="form-control" id="nom" name="nom"placeholder="Name"   value="{{ $for->nom }}" required><br><br>
                    </div>
                    </div>
                    <div class="form-group row">
                    <div class="cl">
                       
                        <input type="text" class="form-control" id="numerofor" name="numerofor" placeholder="Provider Number"  value="{{ $for->numerofor }}" required>
                    </div>
                </div><br>
                <div class="form-group row">
                    ...
                    <div class="cl">
                        ...
                        <input type="text" class="form-control" id="telephone" name="telephone" placeholder="Phone Number"  value="{{ $for->telephone }}">
                    </div>
                </div><br>

                <div class="form-group">
                <div class="cl">
                       <input type="email" class="form-control" id="email" name="email" placeholder="Email"   value="{{ $for->email }}" required><br><br>
                </div>
                </div>
            ...
            <div class="col-md-6">
                ...
                <div class="for-address">
                    <h2>Address Form</h2>
                        ...
                        <div class="form-group">
                        <div class="pass">
                            <input type="text" class="form-control" id="addr2" name="addr2"  placeholder="Address 2" value="{{ $addr->addr2 }}">
                        </div>
                        </div><br>
                        <div class="form-group row">
                            <div class="col">
                                <input type="text" class="form-control" id="codepos" name="codepos" placeholder="Postal Code" value="{{ $addr->codpos }}" >
                            </div>
                            <div class="col">
                                <input type="text" class="form-control" id="ville" name="ville"  placeholder="City"  value="{{ $addr->ville }}" required>
                            </div>
                        </div>
...
<div class="col-md-6">
    ...
    <div class="form">
        ...
        <br>
            <div class="form-group row">
            <div class="pol">
                <select class="form-control" id="taxe" name="taxe" placeholder="Tax" value="{{ $ifor->tax }}" required>
