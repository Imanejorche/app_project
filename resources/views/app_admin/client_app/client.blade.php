...
@section('content')
   ...
   <div class="flex flex-col w-full h-screen px-4 py-8 mt-10">
    <div class="container">
        <a href="{{ route('clientCR') }}" class="btn-create-client">Create customer</a>
            ...
            @foreach ($clients as $client)
                <tr>
                    ...
                    <td style="display: flex; align-items: center; margin-left: 60px;">
                        <form action="{{ route('clients.destroy', $client->id) }}" method="POST" style="margin-right: 10px;">
                            @csrf
                            @method('DELETE')
                        ...
                        <a href="{{ route('sshow',$client->id) }}"><img src="{{ asset('images/crayon.png') }}" alt="update" style="width: 18px; margin-right:30px"></a>
                    </td>
                </tr>
            @endforeach
        </tbody>
