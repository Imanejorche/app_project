            ...
            <h2>Employee Overview</h2>
                <div class="form-group row">
                    <div class="col-md-6">
                        ...
                        <input type="text" class="form-control" id="nom" name="nom"placeholder="First Name" required><br><br>
                    </div>
                    <div class="col-md-6">
                       
                       <input type="text" class="form-control" id="prenom" name="prenom" placeholder="Last Name" required><br><br>
                   </div>
                    </div>
                    <div class="form-group row">
                    <div class="cl">
                       
                        <input type="text" class="form-control" id="numeroemp" name="numeroemp" placeholder="Employee Number" required>
                    </div>
                </div><br>
                <div class="form-group row">
...
<div class="col-md-6">
    ...
    <div class="form">
        ...
        <div class="form-group row">
            <div class="pol">
                <select class="form-control" id="foremp" name="foremp" placeholder="Employer" required>
                    @foreach($fors as $for)
