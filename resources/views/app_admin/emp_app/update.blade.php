            ...
            <h2>Employee Overview</h2>
                <div class="form-group row">
                    <div class="col-md-6">
                        ...
                        <input type="text" class="form-control" id="nom" name="nom"placeholder="Employee FirstName" value="{{ $emp->nom }}" required><br><br>
                    </div>
                    <div class="col-md-6">
                       
                       <input type="text" class="form-control" id="prenom" name="prenom" placeholder="Employee LastName"  value="{{ $emp->prenom }}" required><br><br>
                   </div>
                    </div>
                    <div class="form-group row">
                    <div class="cl">
                       
                        <input type="text" class="form-control" id="numeroemp" name="numeroemp" placeholder="Employee Number"  value="{{ $emp->numeroemp}}" required>
                    </div>
                </div><br>
                <div class="form-group row">
                    ...
                    <div class="cl">
                        ...
                        <input type="text" class="form-control" id="telephone" name="telephone"  value="{{ $emp->telephone }}" placeholder="Phone Number">
                    </div>
                </div><br>

                <div class="form-group">
                <div class="cl">
                       <input type="email" class="form-control" id="email" name="email" placeholder="Email"  value="{{ $emp->email}}" required><br><br>
                </div>
                </div>
                    ...
                    <h2>Address Form</h2>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="pass">
                                ...
                                <input type="text" class="form-control" id="pays" name="pays" value="{{ $addr->pays }}"  placeholder="Country" required>
                            </div>
                        </div><br>
                        <div class="form-group">
                            <div class="pass">
                            <input type="text" class="form-control" id="addr1" name="addr1" value="{{ $addr->addr1 }}" placeholder="Address 1" required>
                         </div>
                        </div><br>
                        <div class="form-group">
                        <div class="pass">
...
<div class="col-md-6">
    ...
    <div class="form">
        ...
        <div class="form-group row">
            <div class="pol">
                <select class="form-control" id="foremp" name="foremp" placeholder="Employer" value="{{ $ifor->foremp }}" required>
                    @foreach($fors as $for)
                        <option value="{{ $for->nom }}">{{ $for->nom }}</option>
                    @endforeach
                </select>
            </div>
            <div class="pol">
                <input type="text" class="form-control" id="titre" name="titre" placeholder="Title" value="{{ $ifor->titre }}">
            </div>
        </div>
